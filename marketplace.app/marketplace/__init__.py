...
ma = Marshmallow(app)
api = Api(app, prefix='/api_folder/v1')
db = SQLAlchemy(app)
...
css = Bundle('style/base.css','style/header.css', 'style/footer.css', 'style/catalog.css', 'style/modal.css', 'style/category.css',
             ...
             'style/order_history.css', 'style/producer_products.css','style/edit_product.css', 'style/producer_products.css', 'style/producer_orders.css', 'style/order_registration.css',
