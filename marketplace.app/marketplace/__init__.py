...
css = Bundle('style/base.css', 'style/header.css', 'style/footer.css', 'style/catalog.css', 'style/modal.css',
             ...
             'style/sing.css', 'style/validation.css',
...
js = Bundle('script/quantity.js', 'script/table_view.js', 'script/edit_product.js', 'script/registration_consumer.js',
            ...
            'script/cart.js', 'script/create_product.js', 'script/order_placement.js', 'script/order_history.js', 'script/i18n/ru.js', 'script/edit_product_post.js', 'script/producer_orders.js', 'script/phone_mask.js', 'script/category.js',
