...
def get_filtered_orders(args):
    ...
    if order_status == 'Все':
        ...
        # orders = order_schema_list.dump(Order.query.filter_by(producer_id=int(args['producer_id'])).paginate(page,
        #                                                                                                      ORDERS_PER_PAGE)).data
    else:
        ...
        #     Order.query.filter_by(producer_id=int(args['producer_id'])).filter_by(status=order_status).paginate(page,
        #                                                                                                         ORDERS_PER_PAGE)).data
    for order in orders:
        order['items'] = []
